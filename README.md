...
## About this project
This project is a simple version of the linux shell made by taking part of the "Low-level programming & Algorithm - Linux and Unix system programming" projects.\
...
````
git clone https://github.com/Isaiah38/simple_shell
````
